...
public class Model {
  ...
  public void render(GL3 gl, Mat4 modelMatrix) {
    ...
    shader.setFloat(gl, "offset", light.getOffsetX(), light.getOffsetY());
...
*/
    shader.setVec3(gl, "dirLight.direction", light.getDirLightDirection());
    shader.setVec3(gl, "dirLight.ambient", light.getDirLightADS().getAmbient());
    shader.setVec3(gl, "dirLight.diffuse", light.getDirLightADS().getDiffuse());
    shader.setVec3(gl, "dirLight.specular", light.getDirLightADS().getSpecular());
    ...
    shader.setVec3(gl, "spotLight.ambient", light.getSpotLightADS().getAmbient());
    shader.setVec3(gl, "spotLight.diffuse", light.getSpotLightADS().getDiffuse());
    shader.setVec3(gl, "spotLight.specular", light.getSpotLightADS().getSpecular());
    shader.setFloat(gl, "spotLight.constant", light.getSpotLightConstant());
    shader.setFloat(gl, "spotLight.linear", light.getSpotLightLinear());
    shader.setFloat(gl, "spotLight.quadratic", light.getSpotLightQuadratic());
    shader.setFloat(gl, "spotLight.cutOff", light.getSpotLightCutOff());
    shader.setFloat(gl, "spotLight.outerCutOff", light.getSpotLightOuterCutOff());
